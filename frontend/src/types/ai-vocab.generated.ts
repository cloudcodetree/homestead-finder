...
export const AI_TAG_DESCRIPTIONS: Record<AITag, string> = {
  ...
  infrastructure_needed:
    'Requires major infrastructure work (road, well, septic, power) before occupancy.',
  ...
  flood_risk_mentioned:
    'Floodplain, seasonal flooding, or proximity to waterway mentioned as a concern.',
